<template>
  <div class="mt-14 -ml-1 px-4 md:px-20 max-w-screen-xl mx-auto">
    <h1 class="text-[#2F32A6] text-xl mb-4 md:mb-10">Service Client</h1>
    ...
    <h1 class="text-[#2F32A6] w- text-xl mb-6 md:mb-10">Questions fréquemment posées</h1>

    <div class="w-full space-y-4">
      <div
        v-for="(faq, index) in faqs"
        :key="index"
        class=" px-6  rounded-xl bg-[rgba(240,240,242,1)]"
      >
        <button
    ...
    <section class="py-10 md:ml-50 md:mb-30">
